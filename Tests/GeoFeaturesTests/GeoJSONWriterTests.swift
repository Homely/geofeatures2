...
class GeoJSONWriterCoordinate2DTests: XCTestCase {
    ...
    func testWriteUnsupportedGeometry() {
        ...
        let expected = "Unsupported type \"UnsupportedGeometry(precision: FloatingPrecision, coordinateSystem: GeoFeatures.Cartesian(), dimension: GeoFeatures.Dimension.one)\"."
